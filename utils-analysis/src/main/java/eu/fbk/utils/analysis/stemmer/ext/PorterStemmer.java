...
public class PorterStemmer extends AbstractStemmer implements Stemmer
{
	/**
	 * Define a static logger variable so that it references the
	 * Logger instance named <code>PorterStemmer</code>.
	 */
	static Logger logger = Logger.getLogger(PorterStemmer.class.getName()); 

	/**
	 * A prototype for a PorterStemmer such that only
	...
	/**
	 * Returns <code>PorterStemmer</code> object; only
	 * one <code>PorterStemmer</code> instance can
	 * exist.
	 *
	 * @return	<code>PorterStemmer</code> object
	 */
	public static synchronized PorterStemmer getInstance()
	{
		//logger.debug("PorterStemmer.getInstance");
		// I had to comment here
		// otherwise it isn't thread safe
	...
	{
		//String s = null;
		//logger.debug("stemming " + term + "...");
		//long begin, end;
		/*
		//begin = System.nanoTime();
		s = (String) cache.get(term);
		if (s != null)
		{
			//end = System.nanoTime();
			//logger.debug("found in cache in " + df.format(end - begin) + " ns");
			return s;
		}

		//end = System.nanoTime();
		//logger.debug("not found in cache in " + df.format(end - begin) + " ns");
*/
		//begin = System.nanoTime();
		b = term.toCharArray();
		i = b.length;
		...
		//s = toString();
		//end = System.nanoTime();
		//logger.debug("stemmed in " + df.format(end - begin) + " ns");
	/*	
		
		//begin = System.nanoTime();
		cache.put(term, s);
		//end = System.nanoTime();
		//logger.debug("cached in " + df.format(end - begin) + " ns");
*/
		//return s;
		return toString();
	} // end stem
	...
	public void interactive() throws Exception
	{
		...
		while (true)
		{
			...
			logger.info(query + "\t" + z + "\t" + df.format(end - begin) + " ns");
	...
	*/
	...
	public static void main(String[] args) throws Exception
	{
		...
		PorterStemmer stemmer = PorterStemmer.getInstance();
		// java PorterStemmer
		if (args.length == 0)
		{
			//System.out.println("java PorterStemmer term+");
			stemmer.interactive();
		}
		...
		{
			//stemmer.add(args[i].toCharArray(), args[i].length());
			//stemmer.stem(); 
			//logger.info(stemmer.toString());
