...
class svm_predict {
     ...
     * Logger instance named <code>svm_predict</code>.
     */
    static Logger logger = Logger.getLogger(svm_predict.class.getName());
    ...
    private static void exit_with_help() {
        logger.error("usage: svm_predict [options] test_file model_file output_file\n"
                + "options:\n"
