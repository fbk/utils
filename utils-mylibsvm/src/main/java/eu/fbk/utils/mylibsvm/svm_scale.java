...
class svm_scale {
     ...
     * Logger instance named <code>svm_scale</code>.
     */
    static Logger logger = Logger.getLogger(svm_scale.class.getName());
    ...
    private void run(String[] argv) throws IOException {
        ...
        if (restore_filename != null && save_filename != null) {
            logger.error("cannot use -r and -s simultaneously");
            System.exit(1);
        }
        ...
        try {
            ...
            logger.error("can't open file " + data_filename);
            System.exit(1);
        }
        ...
        if (restore_filename != null) {
            ...
            try {
                ...
                logger.error("can't open file " + restore_filename);
                System.exit(1);
            }
        ...
        try {
            ...
            logger.error("can't allocate enough memory");
            System.exit(1);
        }
        ...
        if (save_filename != null) {
            ...
            try {
                ...
                logger.error("can't open file " + save_filename);
                System.exit(1);
            }
