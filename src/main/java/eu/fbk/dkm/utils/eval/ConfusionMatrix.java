...
import eu.fbk.dkm.utils.eval.PrecisionRecall.Measure;
...
public final class ConfusionMatrix implements Serializable {
    ...
    public static Ordering<ConfusionMatrix> labelComparator(final Measure measure,
    ...
    public static Ordering<ConfusionMatrix> microComparator(final Measure measure,
    ...
    public static Ordering<ConfusionMatrix> macroComparator(final Measure measure,
            final boolean higherIsBetter) {
        return new Ordering<ConfusionMatrix>() {
